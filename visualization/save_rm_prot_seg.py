...
def get_arguments():
    ...
    parser.add_argument('--load_ema_path', type=str, default='results/TBAD/checkpoints')

    # dataset
    parser.add_argument("--data_dir", type=str, default='/home/amishr17/aryan/new_attempt/preprocess/TBAD/ImageTBAD',
                        help="Path to the dataset.")
    parser.add_argument("--list_dir", type=str, default='/home/amishr17/aryan/new_attempt/datalist/AD/AD_0',
    ...
    parser.add_argument("--save_path", type=str, default='home/amishr17/aryan/new_attempt/results',
                        help="Path to save.")
...
def create_dataloader():
    ...
    # Print paths being loaded
    logging.info(f"Loading data from: {args.list_dir}")
    print_file_content(os.path.join(args.list_dir, 'train_lab.txt'))
    print_file_content(os.path.join(args.list_dir, 'train_unlab.txt'))
    print_file_content(os.path.join(args.list_dir, 'test.txt'))

    logging.info("lab set: total {} samples".format(len(train_labset)))
    logging.info("unlab set: total {} samples".format(len(train_unlabset)))
    logging.info("test set: total {} samples".format(len(testset)))

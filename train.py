...
def get_arguments():
    ...
    # Dataset
    parser.add_argument("--data_dir", type=str, default='/home/amishr17/aryan/new_attempt/preprocess/TBAD/ImageTBAD', help="Path to the TBAD dataset.")
    parser.add_argument("--list_dir", type=str, default='/home/amishr17/aryan/new_attempt/datalist/AD/AD_0', help="Paths to cross-validated TBAD datasets, list of test sets and all training sets (including all labeled and unlabeled samples)")
    ...
    parser.add_argument('--num_epochs', type=int, default=500, help='frequency of checkpoint save in pretraining')
    ...
    parser.add_argument('--save_step', type=int, default=10, help='frequency of checkpoint save in pretraining')
...
# def create_model(ema=False):
#     net = VNet_AMC(n_channels=1, n_classes=args.num_classes, n_branches=4)
#     if torch.cuda.is_available():
#         net = net.cuda()
#         net = nn.DataParallel(net)
#         print("Model wrapped in DataParallel and moved to GPU.")
#     else:

...
from dataloader.AortaDisection import AortaDissection
import utils.loss
...
def get_arguments():
    parser = argparse.ArgumentParser(description='Semi-supervised Training for UPCoL with TBAD dataset: Uncertainty-informed Prototype Consistency Learning for Semi-supervised Medical Image Segmentation')
    ...
    # TBAD dataset
    parser.add_argument("--data_dir", type=str, default='../../../data/', help="Path to the TBAD dataset.")
    parser.add_argument("--list_dir", type=str, default='../data/datalist/AD/AD_0/', help="Paths to cross-validated TBAD datasets, list of test sets and all training sets (including all labeled and unlabeled samples)")
    parser.add_argument("--save_path", type=str, default='../opt_folder/results/', help="Path to save training outputs.")
    parser.add_argument("--aug_times", type=int, default=5, help="times of augmentation for training.")

    # Optimization options
    parser.add_argument('--lab_batch_size', type=int,  default=1, help='batch size for labeled data')
    parser.add_argument('--unlab_batch_size', type=int,  default=1, help='batch size for unlabeled data')
    parser.add_argument('--lr', type=float,  default=0.001, help='learning rate')
    parser.add_argument('--num_epochs', type=int,  default=10, help='maximum epoch number for training')
    parser.add_argument('--save_step', type=int,  default=2, help='frequency of checkpoint save')
    parser.add_argument('--consistency_rampup', type=float, default=300.0, help='consistency ramp-up period')

    parser.add_argument('--beta1', type=float,  default=0.5, help='beta1 for Adam optimizer')
    parser.add_argument('--beta2', type=float,  default=0.999, help='beta2 for Adam optimizer')
    parser.add_argument('--scaler', type=float,  default=1, help='multiplier of prototype for loss calculation')
    
    # Miscs
    parser.add_argument('--gpu', type=str,  default='1', help='GPU to use')
    parser.add_argument('--seed', type=int, default=1337, help='seed for random initialization')
...
resultdir = '/home/amishr17/aryan/aorta-dissec/opt_folder'
...
print(f'Checkpoints will be saved in: {savedir}')

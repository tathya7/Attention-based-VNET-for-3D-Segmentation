    ...
    try:
        ...
        if mode == '9th-TypeB':
            ...
            for sample_path in sample_path_list:
                ...
                save_to_h5(processed_img, processed_mask, os.path.join('/home/amishr17/aryan/aorta-dissec/data/TBAD/test/', case_idx + '.h5'))
                ...
                show_graphs(img[:,-256:-240,:],processed_img[:,-256:-240,:],processed_mask[:,-256:-240,:], \
                                (16,32),'/home/amishr17/aryan/aorta-dissec/data/TBAD/test/'+case_idx+'_img2.png')
                ...
                show_graphs_test(img[:,-272:-240,:],resampled_img[:,mid_slice-16:mid_slice+16,:],processed_img[:,-272:-240,:],mask[:,-272:-240,:],processed_mask[:,-272:-240,:], \
                                (25,64),'/home/amishr17/aryan/aorta-dissec/data/test/' +case_idx+'_img6.png')                 
...
if __name__ == "__main__":
    ...
    '''
    root0 = '/home/amishr17/aryan/aorta-dissec/data/'
    root1 = '/home/amishr17/aryan/aorta-dissec/data/TBAD/'
    dst = '/home/amishr17/aryan/aorta-dissec/data/TBAD/'
    target_shape = (128,128,128)
    record_path = '/home/amishr17/aryan/aorta-dissec/data/TBAD/'
    ...
    record_path = '/home/amishr17/aryan/aorta-dissec/data/TBAD/'
    DatasetPreprocess(root0,dst,record_path, mode='ImageTBAD',resample=True,clip=True)

    # record_path = '/home/amishr17/aryan/aorta-dissec/data/TBAD/'
    # atasetPreprocess(root1,dst,record_path, mode='ImageTBAD',resample=False,clip=False)

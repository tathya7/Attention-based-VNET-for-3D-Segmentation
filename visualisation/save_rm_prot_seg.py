...
from codes.dataloader.AortaDisection import AortaDissection
...
# record
logging.basicConfig(filename=save_path + "/showlog.txt", level=logging.INFO, format='[%(asctime)s.%(msecs)03d] %(message)s', datefmt='%H:%M:%S')

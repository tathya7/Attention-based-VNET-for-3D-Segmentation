...
def get_arguments():
    ...
    parser.add_argument('--load_path', type=str, default='/home/amishr17/aryan/aorta-dissec/opt_folder/checkpoints/checkpoints/')

    # dataset
    parser.add_argument("--data_dir", type=str, default='/home/amishr17/aryan/aorta-dissec/data/',
                        help="Path to the dataset.")
    parser.add_argument("--list_dir", type=str, default='/home/amishr17/aryan/aorta-dissec/datalist/AD/AD_0',

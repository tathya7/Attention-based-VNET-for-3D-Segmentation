...
def get_arguments():
    ...
    # dataset
    parser.add_argument("--data_dir", type=str, default='preprocess/TBAD/ImageTBAD',
                        help="Path to the dataset.")
    parser.add_argument("--list_dir", type=str, default='datalist/AD/AD_0',
    ...
    parser.add_argument("--save_path", type=str, default=os.path.expanduser('~/results/test/'),
                        help="Path to save.")
